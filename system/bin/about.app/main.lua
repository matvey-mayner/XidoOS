...
local function draw()
    ...
    window:set(2, 9, colors.orange, colors.white, "  XidoOS  LICENSE  ")
    window:set(2, 11, colors.orange, colors.white, "  XidoCore LICENSE  ")
end
...
while true do
    ...
    if windowEventData[1] == "touch" and windowEventData[3] >= 2 and windowEventData[3] <= 19 then
        ...
        elseif windowEventData[4] == 9 then
            programs.execute("edit", screen, nickname, "/system/LICENSE.txt", true)
